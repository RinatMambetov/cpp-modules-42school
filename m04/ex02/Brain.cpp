...
/*   Updated: 2022/10/12 20:05:14 by greita           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Brain.hpp"

Brain::Brain() : m_thoughts(new std::string[thoughtsSize])
{
...
Brain::Brain(const Brain &orig)
{
	...
	if (orig.m_thoughts)
	{
		m_thoughts = new std::string[thoughtsSize];
		for (int i = 0; i < thoughtsSize; ++i)
		{
...
{
	assert(index >= 0 && index < thoughtsSize);
